  ...
  return (
    <>
      <div className="backdrop-blur-md bg-white/30  rounded-md max-w-md my-60 mx-auto">
        <h1 className="flex items-center justify-center p-2 font-bold mb-1 text-2xl text-white">Cadastro</h1>
        <div className="backdrop-blur-xl bg-white/30 shadow rounded-md space-y-4 p-6 flex flex-col items-center">
          ...
          <button className="bg-blue-500 text-white p-2 w-1/3 rounded-md hover:bg-gradient-to-r from-green-300 to-green-900 transition focus:ease-out duration-300 hover:scale-110">Cadastrar</button>
        </div>
        <div className="flex items-center justify-center">
          
          <Link to="/" href="#" className="text-xl text-violet-900 hover:underline p-1">Voltar pro Login</Link>          </div>
      </div>
    </>
  )
}